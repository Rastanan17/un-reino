...
function renderizarConstelacion(
    direccion = "entrada"
){
    ...
    const constelacion =
        constelaciones[constelacionActual];
    ...
    content.innerHTML = `
        ...
        <div class="constelaciones">
            ...
            <div class="constelaciones-barra">
                ...
                <button
                    class="constelacion-boton"
                    onclick="constelacionAnterior()"
                    ${constelacionActual === 0 ? "disabled" : ""}
                    aria-label="Constelación anterior"
                >
                    ←
                </button>
                ...
                <div class="constelacion-centro">
                    ...
                    <button
                        class="boton-volver-observatorio"
                        onclick="salirDeConstelaciones()"
                    >
                        🔭 Observatorio
                    </button>
                ...
                <button
                    class="constelacion-boton"
                    onclick="constelacionSiguiente()"
                    ${constelacionActual === constelaciones.length - 1 ? "disabled" : ""}
                    aria-label="Siguiente constelación"
                >
                    →
                </button>
            ...
            <div
                class="
                    constelacion-pagina
                    constelacion-${direccion}
                "
            >

                <img
                    class="constelacion-imagen"
                    src="${constelacion.imagen}"
                    alt="${constelacion.nombre}"
                >
...
function animarCambioConstelacion(
    direccion
){
