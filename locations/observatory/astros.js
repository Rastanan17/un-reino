    ...
    content.innerHTML = `
        ...
        <div class="astros">
            ...
            <div class="astros-barra">
                ...
                <button
                    class="astro-boton"
                    onclick="astroAnterior()"
                    ${astroActual === 0 ? "disabled" : ""}
                    aria-label="Astro anterior"
                >
                    ←
                </button>
                ...
                <button
                    class="astro-boton astro-siguiente"
                    onclick="astroSiguiente()"
                    ${astroActual === astros.length - 1 ? "disabled" : ""}
                    aria-label="Siguiente astro"
                >
                    →
                </button>
...
function animarCambioAstro(
    ...
    pagina.classList.add(
        ...
        direccion === "siguiente"
            ? "astro-salida-izquierda"
            : "astro-salida-derecha"
