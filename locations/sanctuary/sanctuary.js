...
function reproducirMusicaSantuario(){
    ...
    reproducirMusica(
        `assets/sounds/ambient_sanctuary${numero}.mp3`,
        0.35
    );
    console.log(
        `🎵 Ambiente del Santuario: ${numero}`
    );
}
function cambiarMusicaSantuario(){
    ...
    console.log(
        `🗺️ Mapa → cambiando ambiente del Santuario`
    );
}
// =======================================
// MOSTRAR SANTUARIO
    ...
    content.innerHTML = `
        ...
        <section class="santuario momento-${momento}">
            ...
            >
                ...
                <img
                    src="assets/images/items/antorcha1.png"
                    alt="Salir al mapa"
                >
            ...
            <div
                class="santuario-musica"
                onclick="
                    reproducirSFX('touch.mp3');
                    cambiarMusicaSantuario();
                "
            >

                <img
                    src="assets/images/items/mapa_letters.png"
                    alt="Cambiar ambiente"
                >
