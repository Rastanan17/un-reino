    ...
    content.innerHTML = `
        ...
        <div class="cuentos">
            ...
            <div class="cuentos-barra">
                ...
                <button
                    class="cuento-boton cuento-anterior"
                    onclick="cuentoAnterior()"
                    ${cuentoActual === 0 ? "disabled" : ""}
                ...
                <div class="cuento-centro">
                    ...
                    <button
                        class="boton-salir-cuentos"
                        onclick="salirDeCuentos()"
                    >
                        🌲 Volver al bosque
                    </button>
                ...
                <button
                    class="cuento-boton cuento-siguiente"
                    onclick="cuentoSiguiente()"
                    ${cuentoActual === cuentos.length - 1 ? "disabled" : ""}
                    aria-label="Cuento siguiente"
                >
                    →
                </button>
            ...
            <div
                class="cuento-pagina cuento-${direccion}"
            >
...
function animarCambioCuento(direccion){
    ...
    const pagina =
        document.querySelector(".cuento-pagina");
