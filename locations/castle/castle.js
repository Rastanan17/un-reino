...
function mostrarCastillo(){
    ...
    content.innerHTML = `
        <section class="castillo">
            ...
            <div
                class="guardias1"
                onclick="hablarGuardias1()">
                <h2 class="name">Guardias</h2>
                <img
                    src="locations/castle/images/guards_1.png"
                    alt="Guardias">
            </div>
            <div
                class="guardias2"
                onclick="hablarGuardias2()">
                <h2 class="name">Guardias</h2>
                <img
                    src="locations/castle/images/guards_2.png"
                    alt="Guardias">
            </div>
            <!-- ===========================
                 OBJETOS
            ...
            <div class="objeto light1">
                <img
                    src="locations/castle/images/light_1.png"
                    alt="Luz">
            </div>
            <div class="objeto light2">
                <img
                    src="locations/castle/images/light_2.png"
                    alt="Luz">
            </div>
            <div class="objeto light3">
                <img
                    src="locations/castle/images/light_3.png"
                    alt="Luz">
            </div>
            <div class="objeto light4">
                <img
                    src="locations/castle/images/light_4.png"
                    alt="Luz">
            </div>
        </section>
    `;
